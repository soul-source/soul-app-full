...
jQuery(function ($) {
    ...
    $('.hwc-slider .hwc-slide-item').each(function () {
...
var navigatorResizeHandler = (function ($) {
    ...
    return function (responsiveDesign) {
        ...
        $(".hwc-slider").each(function () {
            ...
            var nav = slider.siblings(".hwc-slidenavigator");
            if (nav.length) {
                // left offset
...
jQuery(function ($) {
    ...
    $(window).bind("resize", function () {
        ...
        if (typeof responsiveDesign !== "undefined" && responsiveDesign.isResponsive)
            return;
        var sheetLeft = $(".hwc-sheet").offset().left;
        $("header.hwc-header #hwc-flash-area").each(function () {
            var object = $(this);
...
var artButtonSetup = (function ($) {
    ...
    return (function (className) {
        $.each($("a." + className + ", button." + className + ", input." + className), function (i, val) {
            var b = $(val);
            if (!b.hasClass('hwc-button')) {
                b.addClass('hwc-button');
            }
            if (b.is('input')) {
...
var ThemeLightbox = (function ($) {
    ...
    return (function () {
        ...
        function move (index) {
            ...
            $(".hwc-lightbox-wrapper .hwc-lightbox-image:not(.active)").remove();

            var active = $(".hwc-lightbox-wrapper .active");
            var target = $('<img class="hwc-lightbox-image" alt="" src="' + getFullImgSrc($(images[current]).attr("src")) + '" />').click(function () {
            ...
            if (active.length > 0) {
                ...
                $(".hwc-lightbox-wrapper").append(target);
            }

            showArrows();
            showLoader(true);

            bindMouse($(".hwc-lightbox-wrapper").add(target));
        ...
        function showArrows () {
            ...
            if (current === 0) {
                $(".hwc-lightbox-wrapper .arrow.left").addClass("disabled");
            } else {
                $(".hwc-lightbox-wrapper .arrow.left").removeClass("disabled");
            }

            if (current === images.length - 1) {
                $(".hwc-lightbox-wrapper .arrow.right").addClass("disabled");
            } else {
                $(".hwc-lightbox-wrapper .arrow.right").removeClass("disabled");
            }
        }
...
jQuery(window).bind("resize", (function ($) {
    ...
    return function () {
        if (typeof responsiveDesign !== "undefined" && responsiveDesign.isResponsive) {
            $("header.hwc-header .hwc-shapes").children().css("left", "");
            return;
        }
        var sheetWidth = $(".hwc-sheet").width();
        var sheetLeft = $(".hwc-sheet").offset().left;
        $("header.hwc-header .hwc-shapes>*, header.hwc-header>.hwc-textblock, header.hwc-header>.hwc-headline, header.hwc-header>.hwc-slogan, header.hwc-header>.hwc-positioncontrol").each(function () {
            var object = $(this);
...
jQuery(function ($) {
    ...
    if (scripts.length > 0) {
        ...
        path = src.substr(0, src.indexOf("js/script.js"));
    }
