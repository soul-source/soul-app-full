 ...
 *
 */
public class JFrameNotifications extends MyJFrame {
    /* Creates new form */

    public JFrameNotifications(ControllerJFrameNotifications controller, JInternalFrame iFrame) {
    ...
    private void jCheckNonLetteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCheckNonLetteMouseClicked
        ((ControllerJFrameNotifications) controller).refreshList(jCheckNonLette.isSelected());
