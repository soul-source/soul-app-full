...
public class TableModelUser extends MyTableModel {
    private boolean regMode;
    
    public TableModelUser(MyQueryHandler handler,boolean regMode, Permissions perms) {
        super(handler, perms);
    ...
    public void refreshList() {
        ...
        if (this.perms.can(SessionHandler.I().getUser().getLevel(), true, Permissions.PList.READ)) {
            ...
            super.refreshList(MyQueryHandler.getQb().qbBuildName(EntityModelUser.I().ID_UTENTE.getPath())
