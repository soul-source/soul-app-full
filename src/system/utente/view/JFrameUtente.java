...
public class JFrameUtente extends MyJFrame {

    public JFrameUtente(ControllerJFrameUtente controller, JInternalFrame iFrame, boolean regMode) {
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        try {
            ...
            Logger.getLogger(JFrameUtente.class.getName()).log(Level.SEVERE, null, ex);
        }
